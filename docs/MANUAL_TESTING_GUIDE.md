...
- [ ] Уведите камеру от маркера и убедитесь, что видео продолжает воспроизводиться по центру экрана
- [ ] Верните камеру на маркер и убедитесь, что видео снова привязывается к изображению без перезапуска ролика
- [ ] Повторите быстрые циклы потери/возврата маркера и проверьте отсутствие критичного мерцания
...
**Решение:**
1. Проверьте, что установлены Python-зависимости: `pip install -r requirements.txt`
