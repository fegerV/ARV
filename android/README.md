...
2. Сценарии:
   ...
   - Потеря маркера → видео продолжает playback по центру экрана
   - Повторное наведение на маркер → видео возвращается на маркер без рестарта
...
- Текущая версия: **1.0.6** (`versionCode = 6`)
